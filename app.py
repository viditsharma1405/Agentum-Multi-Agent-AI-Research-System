...
.chip {
    ...
    font-size: clamp(0.68rem, 2.5vw, 0.73rem);
    color: #a09890;
    font-family: 'DM Sans', sans-serif;
}
...
.status-waiting { font-family:'DM Mono',monospace; font-size:0.62rem; color:#444; letter-spacing:0.08em; white-space:nowrap; flex-shrink:0; }
.status-running { font-family:'DM Mono',monospace; font-size:0.62rem; color:#ff8c32; letter-spacing:0.08em; white-space:nowrap; flex-shrink:0; }
.status-done    { font-family:'DM Mono',monospace; font-size:0.62rem; color:#50c878; letter-spacing:0.08em; white-space:nowrap; flex-shrink:0; }
...
@media (max-width: 600px) {
    ...
    .report-panel, .feedback-panel { padding: 1rem; }
...
step_card("02", "Reader Agent",  get_step_state("reader"), "Scrapes and extracts deep content from top URL")
